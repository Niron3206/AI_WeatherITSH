...
1. Убедитесь, что у вас установлена версия Python `3.9.X` или выше.
...
I'd recommend that you use [wwo_hist](https://www.worldweatheronline.com/weather-api/api/) api for it.
...
Прогноз погоды с 10:00 до 22:00 на 24.07.2022
...
Прогноз погоды с 0:00 до 12:00 28.01.2023 (температура не очень точная, всё зависит от времени обучения модели)
